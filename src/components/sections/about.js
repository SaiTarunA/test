      ...
      <div className="about workspace">
        ...
        <div
          ...
          style={{
            ...
            width: (isReadingMore || !about[0].image) && "100%"
          }}
        >
          <div className="about-text-container">
            <div className="about-title">
              <h1>
                <span>{about[0].first_text}&nbsp;</span>
                <span className="primary-color">{about[0].second_text}</span>
              </h1>
            </div>
            <div className="about-subtitle">
              <p
                style={{
                  ...
                  WebkitLineClamp: about[0].paragraph_lines_to_show.toString()
                }}
                ref={paragraphRef}
              >
                <span ref={spanRef}>{about[0].paragraph}</span>
              </p>
              <b
                style={{
              ...
              >
                {isReadingMore
                  ? about[0].button_text.less
                  : about[0].button_text.more}
              </b>
            </div>
          </div>
        </div>
