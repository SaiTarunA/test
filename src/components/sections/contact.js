      ...
      <div className="contact workspace">
        ...
        <div className="contact-left-container">
          <div className="contact-title">
            <h1>
              <span>{contact[0].first_text}&nbsp;</span>
              <span className="primary-color">{contact[0].second_text}</span>
            </h1>
          </div>
          <div className="contact-image">{contact[0].contact_image}</div>
        </div>
        <Toast
